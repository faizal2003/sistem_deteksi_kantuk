        ...
        while True:
            ...
            if not self.is_calibrated:
                ...
                if len(faces) == 1:  # Only calibrate when exactly one face is detected
                    ...
                    cv2.putText(display_frame, f"Calibrating... {self.calibration_countdown} frames left", 
                ...
                for face in faces:
                    ...
                    if pos != "Center" and leftPos != "Center":
                        if self.eye_focus_time is None:
                            ...
                            cv2.putText(display_frame, "MATA TIDAK FOKUS!", (10, 100), 
                                        cv2.FONT_HERSHEY_SIMPLEX, 0.6, (0, 0, 255), 2)
                    ...
                    if abs(head_tilt_angle) > self.HEAD_TILT_THRESHOLD:
                        cv2.putText(display_frame, "KEPALA MIRING!", (10, 130), 
                                    cv2.FONT_HERSHEY_SIMPLEX, 0.6, (0, 0, 255), 2)
